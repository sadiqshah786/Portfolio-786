...
export const projects = [
  ...
  },
  {
    ...
    featured: true,
    thumb: ['#8e2de2', '#ffb454'],
    desc: 'A modern creative-agency website with bold visuals, smooth motion and a polished layout.',
    longDesc: ['A creative studio landing site built with Next.js — bold typography, smooth animations and a refined, motion-rich design.'],
    features: ['Bold agency-style design', 'Smooth animations', 'Fully responsive'],
    tech: ['Next.js', 'React', 'CSS3'],
    live: 'https://studio-creative.vercel.app/',
  },
  {
    slug: 'client-studio',
    title: 'Client Studio',
    ...
    featured: false,
    thumb: ['#642b73', '#c6426e'],
    desc: 'A studio/agency web app for managing clients and showcasing work.',
    longDesc: ['A Next.js client & studio management web app with a clean dashboard-style interface.'],
    features: ['Client showcase', 'Dashboard layout', 'Responsive design'],
    tech: ['Next.js', 'React'],
    live: 'https://client-studio.vercel.app/',
  },
  {
    slug: 'sky-line-drone',
  ...
  {
    slug: 'freename-hosting',
    title: 'Freename Hosting',
    category: 'Web Apps',
    featured: false,
    thumb: ['#1a2980', '#26d0ce'],
    desc: 'A domain & hosting landing page with pricing, features and a modern marketing layout.',
    longDesc: ['A hosting/domain marketing site with pricing tiers and a clean, conversion-focused design.'],
    features: ['Pricing & plans', 'Feature sections', 'Modern landing design'],
    tech: ['React', 'Vite'],
    live: 'https://freename-hosting.vercel.app/',
  },
  {
    ...
    featured: false,
    thumb: ['#134e5e', '#71b280'],
    desc: 'Create, preview and download professional invoices in seconds.',
    longDesc: ['An invoice generator that lets you fill in details, preview live and download a clean PDF invoice.'],
    features: ['Live invoice preview', 'PDF download', 'Itemized billing'],
    tech: ['React', 'Vite'],
    live: 'https://invoice-gen-app-sadiq-shahs-projects.vercel.app/',
  },
  {
    ...
    featured: false,
    thumb: ['#42275a', '#734b6d'],
    desc: 'An app that recommends relevant jobs based on your skills and profile.',
    longDesc: ['A job recommendation app that matches candidates to relevant roles based on their skills and profile.'],
    features: ['Skill-based matching', 'Personalized results', 'Clean job cards'],
    tech: ['React', 'Vite', 'API'],
    live: 'https://job-recommendations-wine.vercel.app/',
  },
  {
    slug: 'patient-panel',
  ...
  {
    slug: 'memon-solution',
    title: 'Memon Solution App',
    category: 'Web Apps',
    featured: false,
    thumb: ['#603813', '#b29f94'],
    desc: 'A business solution web app with a clean, functional interface.',
    longDesc: ['A business solution app delivering a clean, practical interface for everyday operations.'],
    features: ['Practical business UI', 'Responsive layout', 'Fast & lightweight'],
    tech: ['React', 'Vite'],
    live: 'https://memon-solution-app-sadiq-shahs-projects.vercel.app/',
  },
  {
    slug: 'gcs-app',
    title: 'GCS',
  ...
  },
  {
    ...
    featured: true,
    thumb: ['#2c3e50', '#3498db'],
    desc: 'Upload a resume and automatically extract structured data — name, skills, experience and education.',
    longDesc: ['A resume parsing tool that reads uploaded CVs and pulls out structured fields like skills, experience and education.'],
    features: ['Resume upload & parsing', 'Structured data extraction', 'Clean results view'],
    tech: ['React', 'JavaScript'],
    live: 'https://resume-parser-786.netlify.app/',
  },
  {
    slug: 'harmony-hrm',
    title: 'Harmony HRM',
    ...
    featured: true,
    thumb: ['#6a11cb', '#2575fc'],
    desc: 'A human-resource management app — employees, attendance, records and workflows in one dashboard.',
    longDesc: ['An HRM web app for managing employees, attendance and records with a clean, dashboard-driven interface.'],
    features: ['Employee management', 'Attendance & records', 'Dashboard UI'],
    tech: ['React', 'Vite'],
    live: 'https://harmony-786.netlify.app/',
  },
  {
    slug: 'employee-admin',
    ...
    featured: false,
    thumb: ['#0f2027', '#2c5364'],
    desc: 'An admin dashboard to manage employees, roles and records.',
    longDesc: ['An employee administration dashboard with tables, roles and record management.'],
    features: ['Employee CRUD', 'Roles & records', 'Responsive tables'],
    tech: ['React', 'Vite'],
    live: 'https://employee-admin.netlify.app/',
  },
  {
    slug: 'audio-video-downloader',
    title: 'Audio & Video Downloader',
    category: 'Web Apps',
    featured: true,
    thumb: ['#ee4f8b', '#ff6b45'],
    desc: 'Paste a link and download audio or video quickly through a clean, simple interface.',
    longDesc: ['A media downloader that fetches audio and video from links with a fast, minimal UI.'],
    features: ['Audio & video download', 'Paste-a-link flow', 'Minimal, fast UI'],
    tech: ['React', 'Node.js'],
    live: 'https://audio-video-786.netlify.app/',
  },
  {
    slug: 'syed-store',
    title: 'Syed Store',
  ...
  },
  {
    ...
    featured: false,
    thumb: ['#232526', '#c9a227'],
    desc: 'An elegant landing page for a private chef / fine-dining service.',
    longDesc: ['A refined marketing site for a private chef service with an upscale, appetizing design.'],
    features: ['Elegant fine-dining design', 'Menu & services', 'Responsive layout'],
    tech: ['React', 'CSS3'],
    live: 'https://chef-prive.netlify.app/',
  },
  {
    slug: 'eobi-essi',
    title: 'EOBI / ESSI Portal',
    category: 'Web Apps',
    featured: false,
    thumb: ['#1a2980', '#26d0ce'],
    desc: 'A portal for EOBI / ESSI social-security records and management.',
    longDesc: ['A web portal for managing EOBI/ESSI social-security records and related workflows.'],
    features: ['Records management', 'Structured portal UI', 'Responsive design'],
    tech: ['React', 'Vite'],
    live: 'https://eobi-essi.netlify.app/',
  },
  {
    slug: 'tip-calculator',
