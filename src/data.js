...
export const projects = [
  {
    ...
    featured: true,
    thumb: ['#7b61ff', '#ee4f8b'],
    desc: 'A tool that turns your GitHub and LinkedIn into a shareable developer portfolio in minutes — with templates, dark/light mode and a matching CV.',
    longDesc: ['Import your GitHub and LinkedIn, pick a template, customize and publish. Google login, cloud save, CV export and one-click sharing — no coding needed.'],
    features: ['GitHub + LinkedIn import', '5 templates, dark/light & theme colors', 'Google auth + cloud publish', 'CV download & code export'],
    tech: ['React', 'Firebase', 'Vite'],
    live: 'https://build-portfolio-786.vercel.app/',
  },
  {
    slug: 'fbr-calculator',
    ...
    featured: true,
    thumb: ['#11998e', '#38ef7d'],
    desc: 'A clean calculator for Pakistan FBR income tax — enter your income and instantly see your tax breakdown.',
    longDesc: ['A fast, responsive tax calculator that computes FBR income-tax slabs and shows a clear, itemized breakdown.'],
    features: ['Live FBR slab calculation', 'Clear tax breakdown', 'Responsive, mobile-first UI'],
    tech: ['React', 'Vite', 'CSS3'],
    live: 'https://fbr-calculator.vercel.app/',
  },
  {
    slug: 'api-hub',
    title: 'API Hub',
    ...
    featured: true,
    thumb: ['#2e9df0', '#00c6ff'],
    desc: 'A hub to browse, explore and test useful public APIs from one clean interface.',
    longDesc: ['A developer-focused hub to discover and try APIs, with a fast searchable interface.'],
    features: ['Browse & search APIs', 'Test endpoints in-app', 'Clean developer UI'],
    tech: ['React', 'Vite', 'REST API'],
    live: 'https://api-hub-786.vercel.app/',
  },
  {
    slug: 'sky-line-drone',
    title: 'Sky Line Drone',
    category: 'Web Apps',
    featured: false,
    thumb: ['#0f2027', '#2c5364'],
    desc: 'A sleek landing page for a drone services company — aerial photography, surveys and more.',
    longDesc: ['A modern marketing site for drone services with striking visuals and clear service sections.'],
    features: ['Service showcase', 'Modern hero visuals', 'Responsive layout'],
    tech: ['React', 'Vite', 'CSS3'],
    live: 'https://sky-line-drone.vercel.app/',
  },
  {
    slug: 'erp-system',
    title: 'ERP System',
    ...
    featured: false,
    thumb: ['#232526', '#414345'],
    desc: 'A business ERP dashboard for managing operations — inventory, records and workflows.',
    longDesc: ['An ERP web app with a data-rich dashboard for managing business operations and records.'],
    features: ['Operations dashboard', 'Records & inventory', 'Responsive tables'],
    tech: ['React', 'Vite'],
    live: 'https://erp-three-alpha.vercel.app/',
  },
  {
    slug: 'patient-panel',
    title: 'Patient Panel Management',
    category: 'Web Apps',
    featured: false,
    thumb: ['#ff5f6d', '#ffc371'],
    desc: 'A healthcare panel for managing patients, records and appointments.',
    longDesc: ['A patient management panel for healthcare workflows — patient records, appointments and status tracking.'],
    features: ['Patient records', 'Appointment tracking', 'Dashboard UI'],
    tech: ['React', 'Vite'],
    live: 'https://export-envoy.vercel.app/',
  },
  {
    slug: 'forge-treasury',
    title: 'Forge Treasury',
    category: 'Web Apps',
    featured: false,
    thumb: ['#232526', '#c9a227'],
    desc: 'A finance/treasury dashboard for tracking balances, transactions and reports.',
    longDesc: ['A treasury management dashboard with balances, transactions and reporting views.'],
    features: ['Balance tracking', 'Transactions view', 'Reports'],
    tech: ['React'],
    live: 'https://forge-treasury.vercel.app/',
  },
  {
    slug: 'gcs-app',
    title: 'GCS',
    ...
    featured: false,
    thumb: ['#2c3e50', '#4ca1af'],
    desc: 'A Next.js web application with a modern, responsive interface.',
    longDesc: ['A Next.js-based web app with a modern UI and responsive, component-driven layout.'],
    features: ['Modern Next.js build', 'Responsive UI', 'Component-driven'],
    tech: ['Next.js', 'React'],
    live: 'https://gcs-iota-one.vercel.app/',
  },
  {
    slug: 'syed-store',
    title: 'Syed Store',
    ...
    featured: false,
    thumb: ['#642b73', '#c6426e'],
    desc: 'An online store with product listings, cart and a clean shopping experience.',
    longDesc: ['An e-commerce store featuring product listings, cart and a smooth shopping flow.'],
    features: ['Product catalog', 'Cart & checkout flow', 'Responsive store UI'],
    tech: ['React', 'JavaScript'],
    live: 'https://syed-store-786.netlify.app/',
  },
  {
    ...
    featured: false,
    thumb: ['#134e5e', '#71b280'],
    desc: 'A platform for students to submit assignments and for teachers to review them.',
    longDesc: ['An assignment submission app where students upload work and teachers review and track it.'],
    features: ['Assignment upload', 'Review & tracking', 'Student/teacher views'],
    tech: ['React', 'Firebase'],
    live: 'https://assignment-submission-app.netlify.app/',
  },
  {
    slug: 'tip-calculator',
    ...
    featured: false,
    thumb: ['#11998e', '#38ef7d'],
    desc: 'Quickly calculate tips and split the bill between people.',
    longDesc: ['A simple, responsive tip calculator that computes tips and splits the total across people.'],
    features: ['Tip calculation', 'Bill splitting', 'Instant results'],
    tech: ['JavaScript', 'CSS3'],
    live: 'https://tip-calculator-786.netlify.app/',
  },
  {
    slug: 'draftcode',
    title: 'DraftCode',
    ...
    featured: false,
    thumb: ['#3a1c71', '#7b61ff'],
    desc: 'A coding / developer web project with a modern, clean interface.',
    longDesc: ['A developer-focused web project with a clean, modern interface.'],
    features: ['Modern developer UI', 'Responsive layout', 'Fast & lightweight'],
    tech: ['React', 'Vite'],
    live: 'https://sadiqdriftcode-786.netlify.app/',
  },
  {
  ...
  },
  {
    ...
    live: 'https://nft-design-786.netlify.app/',
